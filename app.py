...
PREDICTED_LABELS = ["Kane Williamson","Kobe Bryant","Ronaldo","Maria Sharapova"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/b28f4bbf-0930-4bdf-87a8-43e74f88df1b'  #Edit 2
...
st.title("Welcome to sports man image classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("sports man Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/bdnmpr/bdn")
#st.link_button("My Github Repository", "https://github.com/ShilpiShaw25/AP_Polytechnic_Image_classification")
  ...
  pdf_url = "https://raw.githubusercontent.com/bdnmpr/bdn/main/sample.pdf"
